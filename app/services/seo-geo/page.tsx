  ...
  return (
    <>
      ...
      <main className="relative z-10 overflow-clip rounded-b-32 bg-bg-primary">
        ...
        {/* PROOF — Search Console figures, quoted as read, no rounding */}
        <section
          className="px-5 py-20 min-720:py-24"
          style={{ background: 'hsl(var(--bg-secondary))' }}
        >
          <div className="mx-auto max-w-4xl">
            <h2
              className="fade-up text-title-2 font-semibold tracking-tight mb-5 text-center"
              style={{ color: 'hsl(var(--text-primary))' }}
            >
              {t.proofTitle}
            </h2>
            ...
            >
              <table className="w-full min-w-[420px] border-collapse text-left">
                <caption className="sr-only">{t.proofCaption}</caption>
                <thead>
                  <tr style={{ borderBottom: '1px solid hsl(var(--border-subtle))' }}>
                    <th
                      scope="col"
                    ...
                    <th
                      scope="col"
                      className="px-6 py-4 text-right text-caption font-semibold tracking-widest uppercase"
                      style={{
                        color: 'hsl(var(--text-tertiary))',
                        borderLeft: '1px solid hsl(var(--border-subtle))',
                      }}
                    >
                      {t.proofHeaderImpressions}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {t.proofRows.map((row, i) => (
                    <tr
                      key={row.site}
                      style={{
                        borderTop: i > 0 ? '1px solid hsl(var(--border-subtle))' : 'none',
                    ...
                    >
                      ...
                      >
                        <Link
                          href={row.href}
                          className="underline-offset-4 transition-opacity duration-150 hover:opacity-70 hover:underline"
                        >
                          {row.site}
                        </Link>
                      </th>
            ...
            <div
              className="fade-up mt-12 rounded-2xl p-8 min-720:p-10"
              style={{
                background: 'hsl(var(--bg-primary))',
                border: '1px solid hsl(var(--border-subtle))',
              }}
