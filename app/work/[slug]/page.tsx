  ...
  if (!project || !project.caseStudy) {
    return (
      <>
        <NavPill />
        <main
          className="relative z-10 overflow-clip rounded-b-32"
      ...
      >
        ...
        >
          <div className="mx-auto max-w-5xl">
            <Link
              href="/work"
              className="inline-flex items-center gap-2 text-body transition-opacity hover:opacity-60"
        ...
        <div className="relative w-full overflow-hidden" style={{ aspectRatio: '16/7', background: 'hsl(var(--bg-secondary))' }}>
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to bottom, transparent 50%, hsl(var(--bg-primary) / 0.6) 100%)',
            }}
          />
        </div>
        ...
        <section className="px-5 pt-12 pb-10 min-720:pt-16 min-720:pb-14">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="fade-up flex flex-wrap items-center gap-2 mb-6">
              <span className="section-label" style={{ color: 'hsl(var(--text-tertiary))' }}>
                Case Study
              </span>
            ...
            <div className="grid min-720:grid-cols-[1fr_auto] gap-8 items-start">
              <div>
                ...
                <p
                  className="fade-up fade-up-d2 text-body"
        ...
        {/* ── KEY OUTCOMES ────────────────────────────────────────────── */}
        <section
          className="px-5 py-10 min-720:py-14"
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            >
              {lang === 'fr'
                ? `Résultats clés pour ${project.client} :`
                : `Key outcomes for ${project.client}:`}
            </h2>
        ...
        <section className="px-5 py-14 min-720:py-20">
          <div className="mx-auto max-w-5xl">
            <div className="grid min-720:grid-cols-[1fr_1fr] gap-12 items-center">
              <div>
                <p
                  className="fade-up section-label mb-3"
                  style={{ color: 'hsl(var(--accent))' }}
                >
        ...
        {/* ── APPROACH ────────────────────────────────────────────────── */}
        <section
          className="px-5 py-14 min-720:py-20"
          style={{ background: 'hsl(var(--bg-secondary))' }}
        >
          <div className="mx-auto max-w-5xl">
            <div className="grid min-720:grid-cols-[1fr_1fr] gap-12 items-center">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            {project.quote && (
              ...
              >
                ...
                <blockquote
                  className="text-body-lg italic mb-6"
                  style={{ color: 'hsl(var(--text-primary))' }}
                >
                  {project.quote}
                </blockquote>
        ...
        {/* ── CTA ─────────────────────────────────────────────────────── */}
        <section
          className="px-5 py-16 min-720:py-20"
          style={{ background: 'hsl(var(--bg-secondary))' }}
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              {lang === 'fr'
                ? 'Votre projet, le prochain sur cette liste.'
                : 'Your project, next on this list.'}
            </h2>
            <p
            ...
            >
              {lang === 'fr'
                ? 'Remplissez le formulaire. Nous répondons dans les 24h.'
                : 'Fill in the form. We reply within 24h.'}
            </p>
            <Link
              href="/contact"
