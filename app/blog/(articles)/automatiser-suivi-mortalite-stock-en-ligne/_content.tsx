  ...
  if (lang === 'en') return (
    <article className="blog-article">
      ...
      <ul>
        ...
        <li><strong>No reconciliation.</strong> Because there's no shared counter, there's nothing to manually adjust and nothing to re-sync at the end of the day.</li>
