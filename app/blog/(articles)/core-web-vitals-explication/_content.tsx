...
function ArticleFR({ lang }: { lang: 'fr' | 'en' }) {
  return (
    <>
      ...
      <p>Le CLS mesure à quel point les éléments de la page <strong>bougent pendant le chargement</strong>. Vous avez tous vécu cette expérience : vous allez cliquer sur un bouton, et à la dernière milliseconde une image se charge et décale tout le contenu, et vous cliquez sur autre chose.</p>
...
function ArticleEN({ lang }: { lang: 'fr' | 'en' }) {
  return (
    <>
      ...
      <p>CLS measures how much page elements <strong>move during loading</strong>. You&apos;ve all experienced this: you&apos;re about to click a button, and at the last millisecond an image loads and shifts all the content, and you click on something else.</p>
      ...
      <p><strong>Google Search Console</strong>, the &ldquo;Experience&rdquo; section then &ldquo;Core Web Vitals&rdquo;, gives a global view across the entire site, with pages categorized as &ldquo;Good,&rdquo; &ldquo;Needs improvement,&rdquo; and &ldquo;Poor.&rdquo; This is the starting point for prioritizing fixes.</p>
