...
function ArticleEN({ lang }: { lang: 'fr' | 'en' }) {
  return (
    <>
      ...
      <p>Putting a new site live all at once on a Friday evening with no monitoring is an unnecessary risk.</p>
