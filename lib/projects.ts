...
export const projects: Project[] = [
  // ─── SPRINT MOTORS ───────────────────────────────────────────────────────
  {
    ...
    imageChallenge: '/images/sprintmotors-challenge.png',
    imageApproach: '/images/sprintmotors-approach.png',
  ...
  // ─── MOTO PASSION 65 ─────────────────────────────────────────────────────
  {
    ...
    imageApproach: '/images/motopassion65-approach.png',
  ...
  // ─── BORDEAUX RIDE (site VTC) ─────────────────────────────────────────────
  {
    ...
    imageChallenge: '/images/bdxride-challenge.png',
    imageApproach: '/images/bdxride-approach.png',
