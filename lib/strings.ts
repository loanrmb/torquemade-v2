...
export const strings = {
  fr: {
    ...
    webDev: {
      ...
      carouselSteps: [
        { name: 'SEO', title: 'Le SEO technique, concrètement', desc: 'Balisage sémantique HTML, sitemap XML généré automatiquement, meta descriptions uniques par page, temps de chargement optimisé. Le référencement se construit dans le code, pas ajouté après.' },
        { name: 'GEO', title: 'Le GEO, une discipline à part', desc: 'Les moteurs IA (ChatGPT, Perplexity, Claude) ne lisent pas un site comme Google. On structure le contenu pour qu\'il soit cité : schema FAQ et Article, réponses en début de paragraphe, fichier llms.txt dédié aux robots IA.' },
        { name: 'Indexation', title: 'L\'indexation suivie de près', desc: 'Chaque page est soumise à Google Search Console dès sa mise en ligne. On surveille les erreurs d\'exploration et on s\'assure que le contenu est bien indexé, pas juste publié.' },
        { name: 'Performance', title: 'La performance mesurée, pas devinée', desc: 'Images optimisées, chargement différé, hébergement sur un réseau Edge. Chaque page est testée sur les Core Web Vitals avant mise en ligne.' },
        { name: 'Architecture', title: 'Un code propre, qui vous appartient', desc: 'TypeScript, composants documentés, aucune dépendance à une plateforme propriétaire. Le site codé sur mesure reste simple à faire évoluer, par nous ou par une autre équipe.' },
      ],
  ...
  en: {
    ...
    webDev: {
      ...
      carouselSteps: [
        { name: 'SEO', title: 'Technical SEO, in practice', desc: 'Semantic HTML markup, auto-generated XML sitemap, unique meta descriptions per page, optimized load times. Search visibility is built into the code, not added afterward.' },
        { name: 'GEO', title: 'GEO, a discipline of its own', desc: 'AI engines (ChatGPT, Perplexity, Claude) don\'t read a site the way Google does. We structure content so it gets cited: FAQ and Article schema, answer-first paragraphs, a dedicated llms.txt file for AI crawlers.' },
        { name: 'Indexing', title: 'Indexing, tracked closely', desc: 'Every page is submitted to Google Search Console as soon as it goes live. We monitor crawl errors and confirm content is actually indexed, not just published.' },
        { name: 'Performance', title: 'Performance, measured not guessed', desc: 'Optimized images, lazy loading, hosting on an edge network. Every page is tested against Core Web Vitals before going live.' },
        { name: 'Architecture', title: 'Clean code that\'s yours', desc: 'TypeScript, documented components, no dependency on a proprietary platform. A custom-built site stays easy to evolve, whether by us or another team.' },
      ],
