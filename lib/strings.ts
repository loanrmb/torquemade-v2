...
export const strings = {
  fr: {
    ...
    webDev: {
      ...
      bentoTitle: 'Ce qu\'on ne vous dit pas',
      bento: [
        { title: 'Performance réelle', desc: 'Un site lent perd ses visiteurs avant la première ligne lue. On mesure, on optimise, on ne devine pas.' },
        { title: 'Architecture pensée pour durer', desc: 'Pas de dette technique cachée sous une jolie interface.' },
        { title: 'SEO technique dès la conception', desc: 'Le référencement ne se rajoute pas après coup, il se construit dans la structure.' },
        { title: 'Propriété totale', desc: 'Le code vous appartient. Aucune dépendance obligatoire à une plateforme tierce.' },
        { title: 'Un seul interlocuteur technique', desc: 'Vos questions techniques et business trouvent la même réponse, de la même personne.' },
      ],
      processTitle: 'Comment ça se passe',
      process: [
        { title: 'Cadrage', desc: 'Objectifs, contraintes, ROI attendu' },
        { title: 'Prototype', desc: 'Direction visuelle validée avant tout code' },
        { title: 'Développement', desc: 'Next.js/TypeScript, testé, livré sur preview' },
        { title: 'Suivi', desc: 'Support technique après livraison, pas de ticket qui traîne' },
      ],
      ...
      faq: [
        ...
        { q: 'Travaillez-vous avec des solutions comme Shopify ou WordPress ?', a: 'Le sur-mesure Next.js est notre spécialité, mais on peut intervenir sur des stacks existantes selon le contexte.' },
  ...
  en: {
    ...
    webDev: {
      ...
      bentoTitle: 'What we don\'t tell you upfront',
      bento: [
        { title: 'Real performance', desc: 'A slow site loses visitors before the first line loads. We measure and optimize — we don\'t guess.' },
        { title: 'Built to last', desc: 'No hidden technical debt behind a nice interface.' },
        { title: 'SEO built in from day one', desc: 'Search visibility isn\'t bolted on afterward, it\'s built into the structure.' },
        { title: 'Full ownership', desc: 'The code is yours. No mandatory dependency on a third-party platform.' },
        { title: 'One technical point of contact', desc: 'Your technical and business questions get the same answer, from the same person.' },
      ],
      processTitle: 'How it works',
      process: [
        { title: 'Discovery', desc: 'Goals, constraints, expected ROI' },
        { title: 'Prototype', desc: 'Visual direction validated before any code' },
        { title: 'Development', desc: 'Next.js/TypeScript, tested, shipped to preview' },
        { title: 'Ongoing support', desc: 'Technical support after delivery, no ticket left hanging' },
      ],
      ...
      faq: [
        ...
        { q: 'Do you work with solutions like Shopify or WordPress?', a: 'Custom Next.js builds are our specialty, but we can work on existing stacks depending on the context.' },
