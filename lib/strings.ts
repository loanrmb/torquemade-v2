...
export const strings = {
  fr: {
    ...
    webDev: {
      ...
      reframeTitle: 'Aujourd\'hui, tout le monde peut faire un site, surtout avec l\'IA. Peu de gens connaissent les fondamentaux techniques derrière. Encore moins savent vraiment comment être bien référencé sur Google.',
  ...
  en: {
    ...
    webDev: {
      ...
      sitesCompareTitle: 'Let\'s compare',
      ...
      reframeTitle: 'Anyone can build a website these days, especially with AI. Few people understand the technical fundamentals underneath. Even fewer know how to actually rank on Google.',
