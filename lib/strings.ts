  ...
  fr: {
    ...
    about: {
      ...
      differentiators: [
        ...
        { title: 'Pas de template', text: 'Chaque site est construit de zéro, en partant de votre activité, de vos clients et de vos objectifs réels. Aucun thème prémâché, aucune structure recyclée d\'un autre projet : tout est pensé spécifiquement pour vous.' },
        { title: 'Support post-lancement', text: 'Le lancement n\'est qu\'une étape parmi d\'autres. On reste disponible ensuite pour analyser vos statistiques, ajuster ce qui doit l\'être et faire évoluer le site au rythme de votre activité, mois après mois.' },
        { title: 'On respecte nos délais', text: 'Vos lancements, vos campagnes marketing et vos rendez-vous commerciaux sont planifiés bien à l\'avance. Votre site doit être prêt à temps, sans excuse et sans report de dernière minute.' },
  ...
  en: {
    ...
    about: {
      ...
      differentiators: [
        ...
        { title: 'No templates', text: 'Every site is built from scratch, shaped around your business, your customers, and your actual goals. No pre-made themes, no structure recycled from another project — everything is designed specifically for you.' },
        { title: 'Post-launch support', text: 'Launch is just one milestone among many. We stay available afterward to review your analytics, make the adjustments that matter, and evolve the site at the pace of your business, month after month.' },
        { title: 'We actually meet our deadlines', text: 'Your launches, marketing campaigns, and sales meetings are planned well in advance. Your website needs to be ready on time, with no excuses and no last-minute delays.' },
