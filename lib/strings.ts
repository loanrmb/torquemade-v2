  ...
  fr: {
    ...
    about: {
      ...
      differentiators: [
        ...
        { title: 'Interlocuteur unique', text: 'Un seul contact du premier brief jusqu\'à la mise en ligne, et bien au-delà. Pas de chef de projet qui relaie l\'information, pas de développeur junior livré à lui-même sur votre dossier.' },
  ...
  en: {
    ...
    about: {
      ...
      differentiators: [
        ...
        { title: 'Single contact', text: 'One point of contact from the first brief to launch, and well beyond. No relaying project manager passing along information, no junior developer left alone on your project.' },
