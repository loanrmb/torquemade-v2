...
export const posts: Post[] = [
  ...
  },
  {
    ...
    description: { fr: '\"Moto Bordeaux\", \"concessionnaire Honda Gironde\" — les requêtes que vos clients tapent et comment vous positionner dessus efficacement.', en: '"Motorbike Bordeaux", "Honda dealer Gironde" — the queries your clients type and how to rank for them effectively.' },
    date: '16/09/2025',
    category: 'seo',
    readingTime: 7,
  },
  ...
  },
  {
    ...
    description: { fr: '\"VTC Bordeaux aéroport\", \"chauffeur gare Mérignac\" — les requêtes de trajet sont les plus rentables pour un VTC. Comment s\'y positionner.', en: '"VTC Bordeaux airport", "driver Mérignac station" — route queries are the most profitable. How to rank for them.' },
    date: '10/10/2025',
    category: 'seo',
    readingTime: 7,
  },
