...
export const posts: Post[] = [
  ...
  {
    slug: 'site-web-concessionnaire-moto',
    title: { fr: 'Pourquoi les concessionnaires moto ont besoin d\'un site web moderne', en: 'Why Motorcycle Dealers Need a Modern Website' },
    description: { fr: 'Un site vitrine dépassé coûte des ventes. Pourquoi un concessionnaire moto a besoin d\'un site moderne et ce que ça change pour son activité.', en: 'An outdated showcase site costs sales. Why a motorcycle dealer needs a modern site and what it concretely changes.' },
  ...
  {
    slug: 'microsite-marque-moto',
    title: { fr: 'Microsite de marque moto : pourquoi créer un site dédié par marque ?', en: 'Motorcycle Brand Microsite: Why Create a Dedicated Site Per Brand?' },
    description: { fr: 'Un microsite par marque permet de capter des requêtes précises que votre site principal ne peut pas cibler. Comment l\'utiliser en concession moto.', en: 'A brand microsite captures precise queries your main site can\'t target. How to use them at a motorcycle dealership.' },
    date: { fr: '28 août 2025', en: 'August 28, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
    slug: 'cyclone-moto-bordeaux',
    title: { fr: 'Cyclone moto Bordeaux : tout ce qu\'il faut savoir sur la marque', en: 'Cyclone Moto Bordeaux: Everything You Need to Know About the Brand' },
    description: { fr: 'Cyclone est une marque de motos distribuée en France, disponible à Bordeaux. Gamme, tarifs, points forts — tout ce qu\'il faut savoir.', en: 'Cyclone is a motorcycle brand distributed in France, available in Bordeaux. Range, pricing, strengths — everything to know.' },
    date: { fr: '2 septembre 2025', en: 'September 2, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
    slug: 'voge-moto-bordeaux-gironde',
    title: { fr: 'Voge moto Bordeaux : les modèles disponibles en Gironde', en: 'Voge Moto Bordeaux: Models Available in Gironde' },
    description: { fr: 'Voge propose une gamme de motos modernes à des tarifs accessibles. Découvrez les modèles disponibles en Gironde et où les essayer à Bordeaux.', en: 'Voge offers modern motorcycles at accessible prices. Discover models available in Gironde and where to test ride them in Bordeaux.' },
    date: { fr: '5 septembre 2025', en: 'September 5, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
    slug: 'stock-moto-en-ligne-conversion',
    title: { fr: 'Comment présenter son stock de motos en ligne pour convertir', en: 'How to Present Your Motorcycle Stock Online to Convert' },
    description: { fr: 'Un stock bien présenté en ligne transforme les visiteurs en acheteurs. Comment structurer vos fiches motos pour qu\'elles convainquent avant la visite.', en: 'Well-presented stock converts visitors into buyers. How to structure your motorcycle listings to convince before the visit.' },
    date: { fr: '9 septembre 2025', en: 'September 9, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
    slug: 'fiche-produit-moto-redaction',
    title: { fr: 'Fiche produit moto : comment rédiger une description qui vend', en: 'Motorcycle Product Listing: How to Write a Description That Sells' },
    description: { fr: 'Une fiche produit moto ne doit pas juste lister les caractéristiques techniques. Elle doit raconter pourquoi cette moto correspond au besoin du client.', en: 'A motorcycle listing shouldn\'t just list specs. It must tell why this bike matches the client\'s need.' },
    date: { fr: '12 septembre 2025', en: 'September 12, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
  ...
  {
    slug: 'moto-passion-65-seo-tarbes',
    title: { fr: 'Comment Moto Passion 65 a amélioré sa visibilité Google à Tarbes', en: 'How Moto Passion 65 Improved Its Google Visibility in Tarbes' },
    description: { fr: 'Zéro publicité payante. Moto Passion 65 a significativement amélioré sa visibilité Google dans la région de Tarbes grâce au SEO.', en: 'Zero paid advertising. Moto Passion 65 significantly improved its Google visibility in the Tarbes region through SEO.' },
    date: { fr: '19 septembre 2025', en: 'September 19, 2025' },
    category: 'projets',
    readingTime: 7,
  },
  {
  ...
  {
    slug: 'chauffeur-prive-bordeaux-uber',
    title: { fr: 'Chauffeur privé Bordeaux : comment se démarquer d\'Uber en ligne', en: 'Private Driver Bordeaux: How to Stand Out from Uber Online' },
    description: { fr: 'Uber et Bolt dominent les applis. Mais un chauffeur privé indépendant peut capter des clients via le SEO local — sans commission.', en: 'Uber and Bolt dominate the apps. But an independent driver can attract clients through local SEO — without commission.' },
    date: { fr: '26 septembre 2025', en: 'September 26, 2025' },
    category: 'projets',
    readingTime: 7,
  },
  {
  ...
  {
    slug: 'site-web-chauffeur-prive',
    title: { fr: 'Site web pour chauffeur privé : les éléments qui convertissent', en: 'Private Driver Website: The Elements That Convert' },
    description: { fr: 'Un site de chauffeur privé doit rassurer et permettre la réservation en moins de 3 clics. Voici les éléments indispensables.', en: 'A private driver site must reassure and enable booking in under 3 clicks. Here are the essential elements.' },
    date: { fr: '3 octobre 2025', en: 'October 3, 2025' },
    category: 'projets',
    readingTime: 6,
  },
  {
    slug: 'tarification-vtc-fixe-compteur',
    title: { fr: 'Tarification fixe vs compteur : comment l\'afficher clairement en ligne', en: 'Fixed vs Metered Pricing: How to Display It Clearly Online' },
    description: { fr: 'Le prix est le premier frein à la réservation VTC en ligne. Comment afficher votre tarification de façon claire, rassurante et efficace.', en: 'Price is the main barrier to online VTC booking. How to display your pricing clearly, reassuringly, and effectively.' },
    date: { fr: '7 octobre 2025', en: 'October 7, 2025' },
    category: 'projets',
    readingTime: 5,
  },
  {
  ...
  },
  {
    ...
    title: { fr: 'Comment Bordeaux Ride a construit son système de réservation zéro commission', en: 'How Bordeaux Ride Built Its Zero-Commission Booking System' },
    description: { fr: 'Bordeaux Ride propose des trajets premium en Gironde. Plutôt que de dépendre des plateformes, ils ont construit leur propre système. Retour d\'expérience.', en: 'Bordeaux Ride offers premium rides in Gironde. Rather than depending on platforms, they built their own system. A case study.' },
    date: { fr: '14 octobre 2025', en: 'October 14, 2025' },
    category: 'projets',
    readingTime: 7,
  },
  {
