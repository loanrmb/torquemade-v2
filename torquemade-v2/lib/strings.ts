...
export const strings = {
  fr: {
    ...
    hero: {
      ...
      sub: 'On construit des sites qui performent — et les systèmes derrière.',
      cta1: 'Voir les projets',
      cta2: 'Nous contacter',
    },
    stats: [
      { value: '791K+', label: 'Impressions organiques' },
      { value: '7+',    label: 'Sites livrés' },
      { value: '59+',   label: 'Articles publiés' },
    ],
    services: {
      eyebrow: 'Services',
    ...
    work: {
      ...
      filterAll: 'Tous',
      filterWeb: 'Sites web',
      filterLogiciel: 'Logiciel & Systèmes',
    ...
    about: {
      ...
      stats: [
        { value: '7+',    label: 'Sites livrés' },
        { value: '800K+', label: 'Impressions organiques' },
        { value: '59+',   label: 'Articles publiés' },
      ],
      ctaTitle: 'Prêt pour un site qui performe vraiment ?',
      ctaSub: 'Parlez-moi de votre projet. Je réponds vite et je vous dis honnêtement si je suis la bonne personne.',
      ctaButton: 'Démarrer une conversation',
    },
    contact: {
      eyebrow: 'Contact',
      headline: 'Parlons de votre projet.',
      sub: 'Remplissez le formulaire ci-dessous, je réponds dans les 24h. Pas de pitch, pas de pression.',
      firstName: 'Prénom',
      lastName: 'Nom',
      email: 'Email',
      ...
      submit: 'Envoyer →',
      success: '✓ Message envoyé — je reviens vers vous dans les 24h.',
      error: 'Une erreur s\'est produite. Envoyez-moi un email : loanrmb@gmail.com',
    },
    footer: {
  ...
  en: {
    ...
    stats: [
      { value: '791K+', label: 'Organic impressions' },
      { value: '7+',    label: 'Sites delivered' },
      { value: '59+',   label: 'Articles published' },
    ],
    services: {
      eyebrow: 'Services',
      title: 'What we build.',
    ...
    work: {
      ...
      filterAll: 'All',
      filterWeb: 'Websites',
      filterLogiciel: 'Software & Systems',
    ...
    about: {
      ...
      stats: [
        { value: '7+',    label: 'Sites delivered' },
        { value: '800K+', label: 'Organic impressions' },
        { value: '59+',   label: 'Articles published' },
      ],
