...
function Globe({
  ...
  useEffect(() => {
    ...
    // Read the size on the container DIV — always available after mount.
    // Fallback to 500 if layout hasn't been computed yet.
    const size = containerRef.current.getBoundingClientRect().width || 500
